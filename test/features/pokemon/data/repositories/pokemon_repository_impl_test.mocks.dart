...
// in poke_clean_arc_example/test/features/pokemon/data/repositories/pokemon_repository_impl_test.dart.
...
class MockPokemonRemoteDataSource extends _i1.Mock
  ...
  @override
  _i3.Future<_i2.PokemonModel> getPokemon({
    required _i2.PokemonParams? params,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#getPokemon, [], {#params: params}),
            returnValue: _i3.Future<_i2.PokemonModel>.value(
              _FakePokemonModel_0(
                this,
                Invocation.method(#getPokemon, [], {#params: params}),
              ),
          ...
          as _i3.Future<_i2.PokemonModel>);
}
